...
static iexInput*	input[2];

//*****************************************************************************************************************************
//		キー情報関連
//*****************************************************************************************************************************

void KEY_PadAsign(PADSET& padset, int i) { input[i]->PadAsign(padset); }
void KEY_Asign(KEYSET& keyset, int i) { input[i]->Asign(keyset); }


void KEY_Vibration(u32 gain, float period, int i) { input[i]->Vibration(gain, period); }
...
//------------------------------------------------------
//	キー状態設定
void KEY_SetInfo(int i) { input[i]->SetInfo(); }
//	キー状態取得
int	KEY_Get(KEYCODE key, int i) { return input[i]->Get(key); }
//	軸取得
int KEY_GetAxisX(int i) { return input[i]->Get(KEY_AXISX); }
int KEY_GetAxisY(int i) { return input[i]->Get(KEY_AXISY); }
int KEY_GetAxisX2(int i) { return input[i]->Get(KEY_AXISX2); }
int KEY_GetAxisY2(int i) { return input[i]->Get(KEY_AXISY2); }
